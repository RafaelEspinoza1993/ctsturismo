...
Route::get('/ChallengeFour', 'ChallengeController@index')->where('any', '.*');
...
Route::get( '/vehicles/{modelyear}/{make}/{model}?withRating={Rating}', 'ChallengeController@ChallengeThree');